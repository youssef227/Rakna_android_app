...
class _SearchplatesState extends State<Searchplates> {
              ...
              if (snapshot.hasError) {
                return Center(
                    child: Padding(
                      ...
                      child: Image.asset('assets/images/searchcar.png', scale: 1.7.r),
                    ));
                ...
                return  Center(
                  child: Padding(
                    ...
                    child: Image.asset('assets/images/not-found.png', scale: 0.7.r),
                  ),
                );
              }
            },
  ...
  Widget buildUser(UserData user) => ListTile(
        leading: CircleAvatar(child: Text(user.plate)),
